    ...
    const handleSearchEnter = async () => {
        ...
        setTimeout(() => {
            const newGuide: AIGuide = {
                ...
                iconType: 'sparkles',
                readTime: '2 min',
                description: `A custom generated guide focusing on "${searchTerm}" tailored for your ${activeProfile?.cropType || 'Crop'}.`,
                tags: ['ai', 'custom', activeProfile?.cropType || 'general'],
                createdAt: new Date().toISOString(),
                fullContent: `This is a simulated AI guide for **${searchTerm}**. \n\n### Key Steps\n1. Analyze the situation with ${activeProfile?.cropType}.\n2. Apply organic remedies.\n3. Monitor for 3 days.\n\nGenerated by LeafScan Agent.`
            }
            setAiGuide(newGuide)
    ...
    const DetailView = () => (
        <article className="animate-fade-in space-y-8">
            ...
            <div className="prose prose-emerald max-w-none prose-lg prose-headings:font-serif prose-headings:font-bold prose-headings:text-stone-800">
                ...
                <div className="whitespace-pre-wrap text-stone-600 leading-relaxed font-serif">
    ...
    return (
        <PageShell
            ...
            badge={selectedGuide ? (
                ...
                <div className="bg-emerald-100 text-emerald-800 text-xs px-3 py-1 rounded-full font-sans uppercase tracking-wider font-bold inline-flex items-center gap-1 shadow-sm border border-emerald-200/50">
                            ...
                            <div className="space-y-4">
                                {isGenerating ? (
                                    <div className="bg-white/50 rounded-3xl p-12 text-center border border-stone-200/50 animate-pulse">
                                        ...
                                        <h3 className="text-lg font-bold text-stone-800">Consulting Global Agronomy Database...</h3>
                                        <p className="text-stone-500">Generating bespoke guide for &quot;{searchTerm}&quot;</p>
                                    </div>
                                ) : aiGuide ? (
                                    <div
                                    ...
                                    >
                                        <div className="absolute top-0 right-0 p-3 bg-emerald-100/50 rounded-bl-2xl text-emerald-800 font-bold text-xs">New AI Guide</div>
